...
namespace hoverboard_hardware_interface
{
    hardware_interface::CallbackReturn HoverboardHardwareInterface::on_init(const hardware_interface::HardwareInfo & info)
    {
        ...
        frontLeftWheel = MotorWheelFront(hardwareConfig.frontLeftWheelJointName, hardwareConfig.encoderTicksPerRevolution);
        frontRightWheel = MotorWheelFront(hardwareConfig.frontRightWheelJointName, hardwareConfig.encoderTicksPerRevolution);
        backLeftWheel = MotorWheelBack(hardwareConfig.backLeftWheelJointName, hardwareConfig.encoderTicksPerRevolution);
        backRightWheel = MotorWheelBack(hardwareConfig.backRightWheelJointName, hardwareConfig.encoderTicksPerRevolution);
    ...
    hardware_interface::return_type HoverboardHardwareInterface::write(const rclcpp::Time &, const rclcpp::Duration &)
    {
        ...
        RCLCPP_INFO(rclcpp::get_logger("SerialPortServiceFront"), "Front: %i %i", frontMotorWheelDriveControl.speed, frontMotorWheelDriveControl.steer);
        RCLCPP_INFO(rclcpp::get_logger("SerialPortServiceBack"), "Back: %i %i", backMotorWheelDriveControl.speed, backMotorWheelDriveControl.steer);
        
        RCLCPP_INFO(rclcpp::get_logger("SerialPortServiceFront"), "Sending front motor commands: speed=%i, steer=%i", frontMotorWheelDriveControl.speed, frontMotorWheelDriveControl.steer);
        RCLCPP_INFO(rclcpp::get_logger("SerialPortServiceBack"), "Sending back motor commands: speed=%i, steer=%i", backMotorWheelDriveControl.speed, backMotorWheelDriveControl.steer);
